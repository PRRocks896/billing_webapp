...
import UseEmployeeWellnessEnquiry from "./useEmployeeWellnessEnquiry";

const EmployeeWellnessEnquiry = () => {
    const {
        list,
        page,
        rows,
        ...
        searchHandler,
        handleRequestSort,
    } = UseEmployeeWellnessEnquiry();

    const title = "Employee Wellness Enquiry"
...
export default EmployeeWellnessEnquiry;