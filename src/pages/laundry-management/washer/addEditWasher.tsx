...
import UseAddEditWasher from "./hooks/useAddEditWasher";
import {
    ArrowLeft,
    Building,
    User,
                    ...
                    <Stack direction="row" alignItems="center" spacing={2.5}>
                        ...
                        <Box>
                            ...
                            <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
                                Manage laundry shop profiles, contact details, and banking information for settlements.
                            </Typography>
                        </Box>
                    </Stack>
                    <Button
