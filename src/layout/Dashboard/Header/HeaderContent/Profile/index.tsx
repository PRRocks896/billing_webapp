    ...
    <Box sx={{ flexShrink: 0, ml: 0.75 }}>
      <Stack direction="row" spacing={2} alignItems="center" sx={{ p: 0.5 }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <Typography variant='h5' color="text.primary">{user?.branchName}</Typography>
          <Typography variant="h6" color="text.secondary">{currentTime.toLocaleString()}</Typography>
        </Box>
        <ButtonBase
          sx={(theme) => ({
            p: 0.25,
                    ...
                    <Grid container sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
                      <Grid>
                        <Stack direction="row" sx={{ gap: 1.25, alignItems: 'center' }}>
                          <Avatar alt="profile user" src={avatar1} />
                          <Stack>
                            <Typography variant="subtitle1">{user?.branchName}</Typography>
