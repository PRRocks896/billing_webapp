...
const FaceRegister: React.FC = () => {
  ...
  const handleCapture = useCallback(() => {
    ...
    startLivenessCheck();
  }, [selectedStaff, enqueueSnackbar, startLivenessCheck]);
  ...
  return (
    <Box sx={{ maxWidth: 1000, mx: 'auto', p: { xs: 2, md: 3 } }}>
      ...
      <Stack direction="row" alignItems="center" spacing={2} mb={3}>
        ...
        {uiState === 'success' && (
          <Chip label="Registration Successful" color="success" icon={<TickCircle size={16} />} sx={{ ml: 'auto' }} />
        )}
      </Stack>
      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 12, md: 7 }}>
          ...
          >
            ...
            {/* Video Feed */}
            <Box sx={{ position: 'relative', bgcolor: '#0a0a0a', minHeight: 360 }}>
              <video
                ref={videoRef}
                autoPlay
                muted
            ...
            <Box sx={{ p: 2, bgcolor: 'background.paper' }}>
              ...
              <Stack direction="row" spacing={1.5}>
                ...
                <Button
                  ...
                  onClick={handleReset}
                  disabled={isLoading}
                  sx={{ borderRadius: 2, px: 3, minWidth: 'fit-content' }}
                >
                  Reset
                </Button>
              </Stack>
