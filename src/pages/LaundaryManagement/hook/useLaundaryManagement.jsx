...
const useLaundryManagement = () => {
    ...
    const deleteHandler = async () => {
        try {
            ...
            dispatch(startLoading());
            const response = await deleteLaundaryManagement(deleteId);
    ...
    const changeStatusHandler = async (e, id) => {
        try {
            ...
            const response = await updateLaundaryManagement(payload, id);
    ...
    // search Advance
    const searchLaundaryManagementHandler = async (payload) => {
        try {
            fetchLaundryManagementData(payload.searchValue);
        } catch (error) {
            showToast(error?.message, false);
        }
    };
...
export default useLaundryManagement;