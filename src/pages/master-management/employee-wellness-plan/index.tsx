...
import UseEmployeeWellnessPlan from "./hooks/useEmployeeWellnessPlan";

const EmployeeWellnessPlan = () => {
    const {
        list,
        page,
        rows,
        ...
        handleRequestSort,
        closeConfirmModal
    } = UseEmployeeWellnessPlan();

    const title = "Employee Wellness Plan"
                ...
                <Stack direction="row" alignItems="center" spacing={2}>
                    ...
                    <Box>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            View, manage, and configure all available employee wellness plans.
                        </Typography>
                    </Box>
                </Stack>
            </Stack>
...
export default EmployeeWellnessPlan