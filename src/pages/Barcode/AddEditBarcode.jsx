...
import useAddEditBarcode from "./hook/useAddEditBarcode";


const AddEditBarcode = ({ tag }) => {
    const { control, handleSubmit, onSubmit, cancelHandler } = useAddEditBarcode(tag);
